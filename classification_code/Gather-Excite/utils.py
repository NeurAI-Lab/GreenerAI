...
def get_network(args,ge_trained=False, use_gpu=True):
    ...
    if args.net == 'vgg16':
        ...
        net = resnet50()
    elif args.net == 'resnet50_ge':
        from models.resnet_ge import resnet50_ge
        net = resnet50_ge(ge_trained)
    ...
    elif args.net == "cc_resnet50":
        from models.cc_resnet import cc_resnet50
        net = cc_resnet50()
    # elif args.net == "sp_b_resnet50":
    #     from models.spatial_bottleneck_resnet import sp_b_resnet50
    #     net = sp_b_resnet50()
    elif args.net == "sp_resnet50":
