...
def dilated_resnet50(pretrained=False, root="./pretrain_models", **kwargs):
...
def dilated_resnet101(pretrained=False, root="./pretrain_models", **kwargs):
...
def dilated_resnet152(pretrained=False, root="~/.encoding/models", **kwargs):
