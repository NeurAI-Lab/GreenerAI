...
from encoding_custom.in_place_abn.modules.bn import InPlaceABNSync
...
class HighResolutionNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x = F.upsample(x, imsize, **{"mode": "bilinear", "align_corners": True})
...
class HRNet(nn.Module):
    def __init__(
        ...
        self.pretrained = HighResolutionNet(nclass)
        self.pretrained.init_weights(
            "/data/input/pretrained/hrnet_w48_cityscapes_cls19_1024x2048_ohem_trainvalset_modified.pth"
        )
        # self.pretrained.init_weights()
...
if __name__ == "__main__":
    ...
    net = get_hr_net("mapillary", backbone="None", aux=False, se_loss=False)
    out = net(A)
    for o in out:
        print(o.shape)
