...
from encoding_custom.nn.coord_conv_layer import CoordConv
...
class CCBasicBlock(nn.Module):
    ...
    def __init__(
        ...
        super(CCBasicBlock, self).__init__()
...
class CCBottleneck(nn.Module):
    ...
    def __init__(
        ...
        super(CCBottleneck, self).__init__()
...
def cc_resnet18(pretrained=False, root="", **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = CCResNet(CCBasicBlock, [2, 2, 2, 2], **kwargs)
...
def cc_resnet34(pretrained=False, root="", **kwargs):
    """Constructs a ResNet-34 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = CCResNet(CCBasicBlock, [3, 4, 6, 3], **kwargs)
    model.base_inchannels = [64, 128, 256, 512]
    if pretrained:
        assert False, "Pretrained model not implemented"
...
def cc_resnet50(pretrained=False, root="~/.encoding/models", **kwargs):
    """Constructs a ResNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = CCResNet(CCBottleneck, [3, 4, 6, 3], **kwargs)
...
def cc_resnet101(pretrained=False, root="~/.encoding/models", **kwargs):
    """Constructs a ResNet-101 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = CCResNet(CCBottleneck, [3, 4, 23, 3], **kwargs)
    model.base_inchannels = [256, 512, 1024, 2048]
    if pretrained:
        assert False, "Pretrained model not implemented"
        #from ..models.model_store import get_model_file
...
def cc_resnet152(pretrained=False, root="~/.encoding/models", **kwargs):
    """Constructs a ResNet-152 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = CCResNet(CCBottleneck, [3, 8, 36, 3], **kwargs)
    model.base_inchannels = [256, 512, 1024, 2048]
    if pretrained:
        assert False, "Pretrained model not implemented"
