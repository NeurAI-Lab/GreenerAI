...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.addcoords = AddCoords([512, 512])
        self.conv1_cc = nn.Conv2d(3+3, 64, kernel_size=7, stride=2, padding=3, bias=False)
...
def cc1_resnet18(pretrained=False, root="", **kwargs):
...
def cc1_resnet34(pretrained=False, root="", **kwargs):
...
def cc1_resnet50(pretrained=False, root="~/.encoding/models", **kwargs):
...
def cc1_resnet101(pretrained=False, root="~/.encoding/models", **kwargs):
...
def cc1_resnet152(pretrained=False, root="~/.encoding/models", **kwargs):
