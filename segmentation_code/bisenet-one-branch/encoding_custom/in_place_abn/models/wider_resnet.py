...
from encoding_custom.in_place_abn.modules import (
...
class WiderResNet(nn.Module):
    def __init__(self, structure, norm_act=ABN, classes=0, keep_outputs=True):
...
class WiderResNetA2(nn.Module):
    def __init__(
        self, structure, norm_act=ABN, classes=0, dilation=False, keep_outputs=True
    ):
        """Wider ResNet with pre-activation (identity mapping) blocks
...
if __name__ == "__main__":
    ...
    body = inplace_models.__dict__["net_wider_resnet38_a2"](keep_outputs=False)
