    ...
    def __init__(
        ...
        **kwargs
        ...
        self.aspp = ASPP_Module(
            in_channels, atrous_rates, norm_layer, up_kwargs, **kwargs
        )
...
class ASPP_Module(nn.Module):
    def __init__(
        self, in_channels, atrous_rates, norm_layer, up_kwargs, out_channels=None
    ):
        super(ASPP_Module, self).__init__()
        out_channels = (in_channels // 8) if out_channels is None else out_channels
